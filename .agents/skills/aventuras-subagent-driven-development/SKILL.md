---
name: aventuras-subagent-driven-development
...
digraph process {
    ...
    "Code quality reviewer subagent approves?" -> "Mark task complete in the task list" [label="yes"];
    "Mark task complete in the task list" -> "More tasks remain?";
    "More tasks remain?" -> "Dispatch implementer subagent (./implementer-prompt.md)" [label="yes"];
    "More tasks remain?" -> "Dispatch final code reviewer subagent for entire implementation" [label="no"];
    "Dispatch final code reviewer subagent for entire implementation" -> "Use aventuras-finishing-a-development-branch";
}
```
...
- **aventuras-test-driven-development** - Subagents follow TDD for each task

**Alternative workflow:**

- **aventuras-executing-plans** - Use for parallel session instead of same-session execution
